...
public interface MatchRepository extends CrudRepository<Match, Long> {
    ...
    List<Match> getByTeam1AndDateBetweenOrTeam2AndDateBetweenOrderByDateDesc(String teamName1, LocalDate startDate,
            LocalDate endDate, String teamName2, LocalDate startDate1, LocalDate endDate1);
